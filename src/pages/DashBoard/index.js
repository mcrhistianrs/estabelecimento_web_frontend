...
import { FilePlus,FileMinus, Edit2, List,LogOut,User, UserMinus}  from '@styled-icons/feather';
  ...
  return (
    <Container>
      ...
      <Menus>
        ...
        <button onClick={() => setBotao('EditarConta')}>
          <User size="30" color="white" style={{margin:"1vh"}} />
        </button>

        <button onClick={() => setBotao('RemoverConta')}>
          <UserMinus size="30" color="white" style={{margin:"1vh"}} />
        </button>
